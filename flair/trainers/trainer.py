...
class ModelTrainer:
        ...
        **kwargs,
        ...
        try:
            ...
            for epoch in range(0 + self.epoch, max_epochs + self.epoch):
                ...
                if log_train:
                    train_eval_result, train_loss, train_detailed_results_dict = self.model.evaluate(
                        self.corpus.train,
                ...
                if log_dev:
                    dev_eval_result, dev_loss, dev_detailed_results_dict = self.model.evaluate(
                        self.corpus.dev,
                        eval_mini_batch_size,
                        embeddings_in_memory,
                        num_workers=num_workers,
                ...
                if log_test:
                    test_eval_result, test_loss, test_detailed_results_dict = self.model.evaluate(
                        self.corpus.test,
                        eval_mini_batch_size,
                        embeddings_in_memory,
                        base_path / "test.tsv",
    ...
    def final_test(
        ...
        dev_results, dev_loss, dev_detailed_results_dict = self.model.evaluate(
            self.corpus.dev,
        ...
        test_results, test_loss, test_detailed_results_dict = self.model.evaluate(
            self.corpus.test,
            eval_mini_batch_size=eval_mini_batch_size,
            embeddings_in_memory=embeddings_in_memory,
        ...
        return dev_final_score, test_final_score, dev_detailed_results_dict
